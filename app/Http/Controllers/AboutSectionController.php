...
class AboutSectionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Replace the stats in the request
        $request->merge(['stats' => $statsData]);
        ...
        // Create stats
        if (isset($validatedData['stats']) && is_array($validatedData['stats'])) {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image')) {
            // Delete old image
            if ($section->image_path && file_exists(public_path('uploads/image/' . $section->image_path))) {
                unlink(public_path('uploads/image/' . $section->image_path));
            }
